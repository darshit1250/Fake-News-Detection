...
def predict():
  ...
  if algo == 'naive_bayes':
    ...
    print(result_LSTM)
    return "<h3>Using LSTM : </h3>" + "</br>The probability of the News being Reliable is : " + str(float_formatter(result_LSTM[0][0]*100)) + "%</br>The probability of the News being Fake is : " + str(float_formatter((1 - result_LSTM[0][0])*100)) + "%"
  else:
    result_NB = classifier_NB.predict_proba(tfidf_vector)
    result_LR = classifier.predict_proba(tfidf_vector)
    result_PA = classifier_PA.predict(tfidf_vector)
